...
const EmbedPage = () => {
  ...
  if (error && isOpen) {
    return (
      <div className="flex flex-col items-center justify-center h-full bg-light-red-100 text-red-800 p-4 rounded">
  ...
  if (!isOpen) {
    return (
      <button
        onClick={toggleOpen}
        className="w-14 h-14 rounded-full flex items-center justify-center sha shadow-lg hover:brightness-110 transition-all text-white"
