...
const InitialForm = () => {
  ...
  return (
    <div className="w-full max-w-xl mx-auto min-h-screen flex flex-col justify-center">
      ...
      {/* Step indicator */}
      <div className="fixed top-6 right-6 md:top-8 md:right-8 text-xs font-medium text-zinc-600 uppercase tracking-widest pointer-events-none">
        Setup your account
      </div>
        ...
        >
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-medium text-indigo-400 uppercase tracking-wider bg-indigo-600/10 px-2 py-1 rounded-xl backdrop-blur-md animate-float">
            ...
            <div className="relative group">
              {stepData.type === "textarea" ? (
                <Textarea
                  ...
                  className="w-full bg-transparent border-0 border-b border-white/10 text-xl md:text-2xl py-4 pr-12 text-white placeholder:text-zinc-700 focus-visible:ring-0 focus-visible:border-indigo-500 rounded-none min-h-30 shadow-none transition-colors"
                  autoFocus
                />
              ) : (
                <Input
              ...
              <div className="absolute top-1/2 right-0 -translate-y-1/2 text-zinc-600 pointer-events-none">
