...
const SourceDetailsSheet = ({
  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetContent className="w-96 md:max-w-md border-l border-white/10 bg-[#0A0A0E] p-0 shadow-2xl">
        <div className="h-full flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6 no-scrollbar px-4">
          ...
          <SheetFooter className="p-6 border-t border-white/5 bg-[#050509]">
            <Button
              variant="destructive"
              className="w-full bg-red-500/10 text-red-500 hover:bg-red-600"
            >
              Disconnect Source
            </Button>
          </SheetFooter>
