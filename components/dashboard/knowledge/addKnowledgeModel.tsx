...
const AddKnowledgeModal = ({
  ...
  const handleImportWrapper = async () => {
    ...
    if (defaultTab === "website") {
      ...
      if (exists) {
        setError("This website source already exists in your knowledge base.");
        return;
      }
      data.url = websiteUrl;
        ...
        >
          ...
          <div className="p-6 min-h-50 space-y-4">
            ...
            >
              ...
              <div
                className="border-2 border-dashed border-white/10 rounded-xl h-48 flex flex-col items-center justify-center gap-2 cursor-pointer"
                onClick={() => {
