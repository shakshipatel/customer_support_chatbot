      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            className="bg-white/2 border border-white/10 text-white placeholder:text-zinc-600 px-3 py-2 rounded-md w-full"
            value={formData.name}
        ...
        <div className="space-y-2">
          ...
          >
            {TONE_OPTIONS.map((option) => (
              <div
                key={option.value}
                className="flex items-center space-x-2 gap-2 rounded-md border border-white/5 bg-white/1 p-3 hover:bg-white/5 transition-colors"
              >
                <RadioGroupItem
                  value={option.value}
                  id={option.value}
                ...
                <Label htmlFor={option.value} className="flex-1 cursor-pointer">
                  <div className="flex items-center gap-2">
                    ...
                    {option.badge && (
                      <span className="text-[10px] rounded-sm border border-red-500/10 bg-red-500/10 px-1.5 text-red-700">
                        {option.badge}
                      </span>
                    )}
                  </div>
