    ...
    <section id="pricing" className="py-32 px-6 max-w-6xl mx-auto text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        ...
        <div className="p-8 rounded-3xl border border-white/5 bg-zinc-900/20 flex flex-col items-start text-left hover:bg-zinc-900/40 transition-colors">
          ...
          <button className="w-full py-3 cursor-pointer rounded-xl border border-white/10 text-white hover:bg-white/5 transition-colors text-sm font-medium mt-auto">
            Start Free
          </button>
        </div>

        {/* (Second plan can go here later) */}
        <div className=" relative overflow-hidden p-8 rounded-3xl border border-white/10 bg-white/3 flex flex-col items-start text-left hover:bg-zinc-900/40 transition-colors">
          <div className="absolute top-0 right-0 px-4 py-1 text-[10px] bg-white/10 rounded-bl-xl">
            Popular
          </div>
          ...
          <ul className="space-y-3 mb-8 text-sm text-zinc-300 font-light w-full">
            ...
            <li className="flex items-center gap-3">
              <Check className="w-4 h-4 text-indigo-400" /> unlimited Sources
            </li>
            <li className="flex items-center gap-3">
              <Check className="w-4 h-4 text-indigo-400" />
              Community Support
          ...
          <button className="w-full bg-white py-3 cursor-pointer rounded-xl border border-white/10 text-black hover:bg-zinc-200 transition-colors text-sm font-medium mt-auto">
            Get Started
          </button>
        </div>
      </div>
